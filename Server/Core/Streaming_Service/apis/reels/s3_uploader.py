...
def upload_to_S3(video_file) -> list:
    """
    Uploads Video/Reel to Designated **AWS S3**

    :param video_file: Video file that came from API request.
    ...
    video_name = list(str(video_file.name).split(" "))[0]
